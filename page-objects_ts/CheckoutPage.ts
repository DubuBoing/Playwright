...
class CheckoutPage{
    page: Page;
    couponStatus: Locator;
    expiryDateMonth: Locator;
    expiryDateDay: Locator;
    ...
    async fillCheckOut(creditCardNo: string, cvv: string, cardName: string, coupon: string){
